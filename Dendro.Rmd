...
ggplot(combined_data, aes(x = Year, y = std, color = Dataset, linetype = Dataset)) +
    geom_line(data = Allcrn, aes(x = Year, y = std), color = "black", size = 1) +  # Thicker black line
...
ggplot(combinedBAI_data, aes(x = Year, y = std, color = Dataset, linetype = Dataset)) +
  ...
  geom_line(data = AllBAIchrn, aes(x = Year, y = std), color = "black", size = 1) +  # Thicker black line
  labs(x = "Year", y = "BAI (mm/yr2)", title = "Multiple Line Graphs") +
  scale_color_manual(values = c("Sheep Bridge" = "lightgreen", 
                                "Childs" = "red", 
                                "Upper Beasley" = "blue", 
