...
chronologies_list <- list(AllCorcrn, Allcrn) #UBcrn, LBcrn, Childscrn, Sheepcrn)  # Replace with your actual list of chronologies
...
chronologies_list <- list(AllCorcrn, Allcrn, UBcrn)  # Your list of chronologies
for (chrono_data in chronologies_list) {
  Response <- dcc(
    chrono = chrono_data,
    climate = MeanTemp,
